...
# , where x is greater than 3 (x>3), into two coins with value ⌊x4⌋
...
# into two coins with value 4. Each of the resulting coins can be transformed into two coins with value 1
