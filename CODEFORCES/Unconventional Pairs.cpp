...
// integers a1,a2,…,an. It is known that n is even. Petya must divide the participants (numbers) into exactly n2 pairs (ap1,aq1),(ap2,aq2),…(apn2,aqn2)
...
// . The only possible (and therefore optimal) pair is (1,2), its difference is |1−2|=1, the answer is 1

// .

// In the second test case, the array is: [10,1,2,9]
// . We can choose pairs — (1,2) and (9,10): both differences are equal to 1, therefore, the maximum difference is 1

// .

// In the third test case, the array is: [3,8,9,3,3,2]
// . We can choose pairs: (2,3), (3,3), (8,9). The differences are: 1,0,1 — the largest is 1.
