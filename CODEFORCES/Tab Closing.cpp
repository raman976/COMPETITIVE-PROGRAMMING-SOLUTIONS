...
// , where m is the number of remaining tabs. The tabs are always tightly arranged in sequence from the left endpoint of the screen; that is, the x's will be at len,2⋅len,3⋅len,…,m⋅len
...
// and press once, then move it to 6 and press again. It can be proved that the tabs cannot be closed with less than 2 moves.
