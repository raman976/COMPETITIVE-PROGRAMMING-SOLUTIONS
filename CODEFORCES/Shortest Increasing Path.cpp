...
// axis, the second along the y axis, the third along the x axis, and so on. Formally, if we number steps from one in the order they are done, then odd-numbered steps must be along the x axis and even-numbered steps must be along the y
...
// by moving 5 along the x axis and then to (5,6) by moving 6 along the y
