...
// such that 0≤x≤a (the current value of a
// , not initial),
// set a:=a⊕x
// . Here, ⊕
...
// operations (values of x used in each operation) that transforms a into b
...
// from a using the allowed operations, print a single line containing −1

// .

// Otherwise, on the first line print a single integer k
// (0≤k≤100) — the number of operations. On the second line print k integers (x1,x2,…,xk) — the chosen values of x
...
// , now a becomes equal to 9⊕7=14
// .
// choose x=8
// , now a becomes equal to 14⊕8=6
