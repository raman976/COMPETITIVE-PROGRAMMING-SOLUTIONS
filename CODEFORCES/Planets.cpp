...
// One day, Vogons wanted to build a new hyperspace highway through a distant system with n
// planets. The i-th planet is on the orbit ai
...
//     The first machine in one operation can destroy any planet at cost of 1

// Triganic Pu.
// The second machine in one operation can destroy all planets on a single orbit in this system at the cost of c
...
// ) — the number of planets and the cost of the second machine usage.

// The second line contains n
// integers a1,a2,…,an (1≤ai≤100), where ai is the orbit of the i
...
// In the first test case, the cost of using both machines is the same, so you can always use the second one and destroy all planets in orbit 1
...
// Triganic Pus to destroy all the planets in orbit 2

// , then destroy the remaining two planets using the first machine.
