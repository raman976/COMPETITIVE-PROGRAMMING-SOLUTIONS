...
of n bags of candies. The i-th bag has ai candies. The bags are given to the players in the order from the first bag to the n
...
space-separated integers ai (1≤ai≤100
...
candies, which is even, so Mihai takes it — Mihai has 4 candies, and Bianca has 0
.
the second bag has 1
candies, which is odd, so Bianca takes it — Mihai has 4 candies, and Bianca has 1
.
the third bag has 2
candies, which is even, so Mihai takes it — Mihai has 6 candies, and Bianca has 1
.
the fourth bag has 3
candies, which is odd, so Bianca takes it — Mihai has 6 candies, and Bianca has 4
