...
// and b and asked to append all characters from b to string a in any order. The guys decided to divide the work between themselves and, after lengthy negotiations, determined who would add each character from string b to a
...
// (1≤m≤10) — the length of the strings b and c
...
// , consisting of the characters 'V' and 'D' — the distribution of the characters of string b between Dima and Vlad. If ci = 'V', then the i
...
// . Then Dima appends the character a to the end of the string, resulting in ota, and Vlad appends the last character, resulting in dota
