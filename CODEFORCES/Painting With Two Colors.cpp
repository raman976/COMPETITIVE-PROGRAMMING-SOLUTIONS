...
// Consider a row of n
// cells, initially all white and indexed from 1 to n

// . You will perform the following two steps in order:

//     Choose an integer x

// such that 1≤x≤n−a+1, and paint the a consecutive cells x,x+1,…,x+a−1
// red.
// Choose an integer y
// such that 1≤y≤n−b+1, and paint the b consecutive cells y,y+1,…,y+b−1
...
// from 1 to n (inclusive), the color of cell i is the same as the color of cell (n+1−i). Your task is to determine whether there exist integers x and y
