...
// , 2, and 3; let's denote the energy level of the i-th crystal as ai. Initially, all of them are discharged, meaning their energy levels are equal to 0. Each crystal needs to be charged to level x (exactly x
