...
# be a collection of multisets s1,s2,…,sk such that each element appears the same number of times in B and across all of s1,s2,…,sk

# .

# For example, some partitions of {1,2,3,3}
# include {1,3}+{2,3},{1,2,3,3}, and {2}+{1,3}+{3}, but not {1,2}+{3}
...
# of size n. Find the minimum score over all valid partitions of A
...
# integers A1,A2,…,An denoting the elements of A (0≤Ai≤100
...
# can be obtained by the partition {0}+{0}+{0}. The partition is valid because each multiset has a mex of 1
