...
# Dalton is the teacher of a class with n
# students, numbered from 1 to n. The classroom contains n chairs, also numbered from 1 to n. Initially student i is seated on chair pi. It is guaranteed that p1,p2,…,pn is a permutation of length n
...
# integers p1,p2,…,pn (1≤pi≤n) — pi denotes the initial chair of student i. It is guaranteed that p
...
# and 2 to get the array [2,1,3]. Then he can swap chairs of students 2 and 3 to get the array [2,3,1]. At this point all the students are happy, and he performed 2

# moves. It is impossible to perform the task with fewer moves.

# In the third test case, by swapping the chairs of students 1
# and 2 and then swapping the chairs of students 4 and 5, Dalton gets the array [2,1,5,3,4] in 2 moves.
