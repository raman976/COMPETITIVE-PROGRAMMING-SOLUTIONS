...
// gears, where gear i has ai

// teeth, and he wants to arrange them into a row.

// After he arranges them, Steve will spin the leftmost gear at a speed of 1
// revolution per second. For each of the other gears, let x be the number of teeth it has, y be the number of teeth of the gear to its left, and z be the speed the gear to its left spins at. Then, its speed will be yx⋅z
