...
// -th minute. Initially (at the start of the 0-th minute), FJ is at the starting side of the gym, which we will denote as side 0. The opposite side of the gym is denoted side 1

// .

// The pacer test audio plays n
// times. At the start of the ai-th minute, FJ must be at the bi
...
// and m (1≤n≤2⋅105,n≤m≤109

// ) — the number of requirements and the number of total minutes.

// The following n
// lines contain two integers ai and bi (1≤ai≤m,bi∈{0,1}) — the i-th requirement by the audio. It is guaranteed that ai>ai−1 over all i>1
...
// .
// During minute 1
// , FJ can run to side 1 and gain 1
// point.
// Right before minute 2
// , the audio requires FJ to be at side 1. Here, FJ is indeed at side 1
// .
// During minute 2
// , FJ can run to side 0 and gain 1
// point.
// During minute 3
// , FJ can stay at side 0
// .
// Right before minute 4
// , the audio requires FJ to be at side 0. Here, FJ is indeed at side 0
// .
