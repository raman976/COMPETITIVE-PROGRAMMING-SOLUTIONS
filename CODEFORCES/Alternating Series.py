...
# For all subarrays∗
# with length at least 2, the sum of all elements in the subarray is positive†

#     . 

# Additionally, we say a good array a
# of length n is better than another good array b of length n if [|a1|,|a2|,…,|an|] is lexicographically smaller‡ than [|b1|,|b2|,…,|bn|]. Note that |z| denotes the absolute value of integer z
...
# ‡
# A sequence a is lexicographically smaller than a sequence b
...
# and b differ, the sequence a has a smaller element than the corresponding element in b
...
# and a1+a2=1>0, it satisfies the two constraints. In addition, it can be shown that the corresponding b=[1,2] is better than any other good array of length 2
