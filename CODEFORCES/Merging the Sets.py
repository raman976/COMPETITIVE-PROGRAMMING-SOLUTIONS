...
# You are given n
# sets S1,S2,…,Sn, where each element in the sets is an integer between 1 and m
...
# and m (2≤n≤5⋅104, 1≤m≤105

# ) — the number of sets and the upper bound of the integers in the sets.

# Then n
# lines follow, the i-th line first containing an integer li (1≤li≤m) — the size of set Si

# .

# Then li
# integers Si,1,Si,2,…,Si,li follow in the same line (1≤Si,1<Si,2<⋯<Si,li≤m) — the elements of set Si
...
# — both 1 and 2 are included in S1
# ;
# S1
# and S2 — 1 is included in S1 and S2, and 2 is included in S1
# ;
# S1
# and S3 — 1 is included in S1, and 2 is included in S1 and S3
# ;
# S2
# and S3 — 1 is included in S2, and 2 is included in S3
# ;
# S1
# , S2, and S3 — 1 is included in S1 and S2, and 2 is included in S1 and S3

#     . 

# Note that it is invalid to choose S2
# only because 2 is not included in S2
