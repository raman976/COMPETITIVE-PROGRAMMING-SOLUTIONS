...
In 1
operation Alex can choose any l and r such that 1≤l≤r≤n, and multiply all elements of the array from l to r inclusive by −1. In other words, Alex can replace the subarray [al,al+1,…,ar] by [−al,−al+1,…,−ar] in 1

operation.

For example, let n=5
, the array is [1,−2,0,3,−1], l=2 and r=4, then after the operation the array will be [1,2,0,−3,−1]
...
In the first test case, Alex can make operations: (1,4)
, (2,2), (6,6)

.

In the second test case, to get the largest sum you need to make operations: (1,8)
, (5,6)
