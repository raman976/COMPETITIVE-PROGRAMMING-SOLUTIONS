...
// and b of length n (0≤ai,bi≤106). They will play a game that lasts for n turns, where Ajisai moves on odd-numbered turns and Mai moves on even-numbered turns. On the i-th turn, the player to move may choose to swap ai and bi
...
// integers, a1,a2,…,an (0≤ai≤106

// ).

// The third line of each test case contains n
// integers, b1,b2,…,bn (0≤bi≤106
...
// and b1. Now the arrays are a=[3,4,6,1] and b=[1,2,3,7]

// .

// On turn 2, Mai chooses to swap a2
// and b2. Now the arrays are a=[3,2,6,1] and b=[1,4,3,7]
...
// and b4. Now the arrays are a=[3,2,6,7] and b=[1,4,3,1]
