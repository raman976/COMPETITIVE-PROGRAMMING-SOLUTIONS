...
// Given an array a
// of length n, containing integers. And there are two initially empty arrays b and c. You need to add each element of array a to exactly one of the arrays b or c

// , in order to satisfy the following conditions:

//     Both arrays b

// and c are non-empty. More formally, let lb be the length of array b, and lc be the length of array c. Then lb,lc≥1
// .
// For any two indices i
// and j (1≤i≤lb,1≤j≤lc), cj is not a divisor of bi

//     . 

// Output the arrays b
// and c that can be obtained, or output −1
...
// (2≤n≤100) — the length of array a

// .

// The second line of each test case contains n
// integers a1,a2,…,an (1≤ai≤109) — the elements of array a
...
// and lc — the lengths of arrays b and c

// respectively.

// In the second line, output lb
// integers b1,b2,…,blb — the elements of array b

// .

// In the third line, output lc
// integers c1,c2,…,clc — the elements of array c
...
// and c=[2,4]. Then elements 2 and 4 do not divide elements 1,3 and 5
