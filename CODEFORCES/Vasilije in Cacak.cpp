...
// , k, and x, and he has to determine if he can choose k distinct integers between 1 and n, such that their sum is equal to x
...
// , k and x (1≤n≤2⋅105, 1≤k≤n, 1≤x≤4⋅1010
...
// , so we can choose the numbers: 2, 3, 5, whose sum is 10
