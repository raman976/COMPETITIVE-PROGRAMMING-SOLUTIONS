...
// . Increase all elements of the array a by x. In other words, he chooses a positive integer x, and for each i (1≤i≤n), he replaces ai with ai+x
// .
// Smash: Set some elements (possibly none or all) of the array a
// to 0. In other words, for each i (1≤i≤n), he either replaces ai with 0
...
// (1≤n≤100) — the number of elements in the array a

// .

// The second line contains n
// integers a1,a2,…,an (1≤ai≤100) — the elements of the target array a
...
// . After an Increase operation with x=2, the array becomes [2,2,2]
// .
...
// We used 2
// Increase operations and 1 Smash operation for a total of 3
