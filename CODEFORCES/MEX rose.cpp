...
// of length n and a number k, where 0≤k≤n

// .

// In one operation, you can choose any index i
// (1≤i≤n) and set ai to any integer value x from the range [0,n]
...
// ∗
// The minimum excluded (MEX) of a set of numbers a1,a2,…,an is the smallest non-negative integer x that does not appear among the ai
...
// and k (1≤n≤2⋅105,0≤k≤n) — the length of the array a and the required MEX(a)
...
// , so MEX=1. By removing zero (replacing it with any x∈[1,n]), we get MEX=0.
