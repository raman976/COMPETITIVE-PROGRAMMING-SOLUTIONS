...
// such that 1≤l≤r≤n, define the average of the subarray al,al+1,…,ar as the sum of elements divided by the number of elements or:
...
// (1≤n≤10) — the length of the array a
