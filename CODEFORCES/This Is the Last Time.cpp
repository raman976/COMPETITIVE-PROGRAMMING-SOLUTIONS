...
// You are given n
// casinos, numbered from 1 to n. Each casino is described by three integers: li, ri, and reali (li≤reali≤ri). You initially have k
...
// and k (1≤n≤105, 0≤k≤109

// ) — the number of casinos and the initial number of coins.

// This is followed by n
// lines. In the i-th line, there are three integers li, ri, reali (0≤li≤reali≤ri≤109) — the parameters of the i
...
// -nd casino. After that, you will have 2 coins. Then you can play at the 1-st casino, and the number of coins will increase to 3. Finally, after playing at the 3-rd casino, you will have 10
...
// -nd casino right away and earn 4 coins.
