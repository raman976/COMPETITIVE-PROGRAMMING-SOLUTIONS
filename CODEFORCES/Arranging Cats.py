...
# Scientists have n
# boxes in which cats may or may not sit. Let the current state of the boxes be denoted by the sequence b1,…,bn: bi=1 if there is a cat in box number i, and bi=0
...
# of n characters, where the i-th character is '1' if there is a cat in the i

# -th box and '0' otherwise.

# The third line of each test case contains a string f
# of n characters, where the i-th character is '1' if there should be a cat in the i
