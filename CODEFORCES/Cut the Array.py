...
# to the element at index r inclusive (i.e., [al+1,al+2,…,ar]
# );
# the suffix from the element at index r+1
# to n inclusive (i.e., [ar+1,ar+2,…,an]
...
# and r that either all numbers s1,s2,s3 are different, or all numbers s1,s2,s3
...
# and r (1≤l<r<n) exists, output these two integers (if there are multiple suitable pairs, you can output any of them). Otherwise, output two integers equal to 0
