...
// You have k
// discount vouchers with values b1,b2,…,bk. A voucher of value x allows you to select exactly x products and pay only for the x−1
...
// integers b1,b2,…,bk (1≤bi≤n

// ) — the values of the discount vouchers.

// It is guaranteed that the sum of n
// across all test cases does not exceed 2⋅105, and the sum of k across all test cases does not exceed 2⋅105

// .
// Output

// Print t
// lines. The i-th line should contain the answer for the i
