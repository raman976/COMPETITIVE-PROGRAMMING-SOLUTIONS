...
// khba has n
// friends, each standing on a line at position ai, and each of them is in the range [0,x]
...
// integers — the k chosen teleport positions. The positions must be distinct and lie within the range [0,x]
