...
Call an array a
of length n sorted if a1≤a2≤…≤an−1≤an
...
(2≤n≤500) — the length of the array a

.

The next line contains n
integers a1,a2,…,an (1≤ai≤109) — the values of array a
...
. The array a then becomes [2,9,11,12]
.
Pick i=3
. The array a then becomes [3,10,12,11]
