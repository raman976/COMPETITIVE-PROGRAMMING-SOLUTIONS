...
(n≥3) and asked him to construct a strictly increasing array of size n

of positive integers, such that

    3⋅ai+2

is not divisible by ai+ai+1 for each i (1≤i≤n−2
...
In the first test case, a1=6
, a2=8, a3=12, so a1+a2=14 and 3⋅a3=36, so 3⋅a3 is not divisible by a1+a2
