...
// be an array of length m such that ci=bi over all 1≤i≤m
// .
// Sort c
// in non-decreasing order.
// If bi≠ci
// over all 1≤i≤m, then b
...
// , then c=[1,3,4,8] after getting sorted. Since bi≠ci in all positions, b
// is a derangement.
// If b=[3,2,1]
// , then c=[1,2,3] after getting sorted. Since b2=c2, b

//     is not a derangement. 

// You are given an array a
// of length n. In one operation, you can delete an element from a
...
// (1≤n≤100) — the length of array a

// .

// The second line of each test case contains n
// integers a1,a2,…,an (1≤ai≤n) — denoting the array a
...
// , the elements that remain in the array. It must be possible to acquire array d after performing some operations on a. Array d
...
// from the array so that it becomes [4,5,2,4]. It can be shown this array is a derangement. This is not the only solution – it can be shown that the original array [4,5,5,2,4]
