...
# and doing the procedure 5 times, you get 21→64→32→16→8→4

# .

# After all k
# iterations, you are left with the final value of x. Unfortunately, you forgot the initial value. Please output any possible initial value of x
...
# is odd, performing the procedure k=1 times results in 1⋅3+1=4, so 1

# is a valid output.

# In the second test case, since 10
# is even, performing the procedure k=1 times results in 102=5, so 10
