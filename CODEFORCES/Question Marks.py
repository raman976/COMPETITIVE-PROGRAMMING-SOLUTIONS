...
questions; each question has 4 options: 'A', 'B', 'C', and 'D'. For each option, there are exactly n correct answers corresponding to that option — meaning there are n questions with the answer 'A', n questions with the answer 'B', n questions with the answer 'C', and n
...
correct answers with option 'A' and 2 correct answers with option 'B'. For example, he would get 4
