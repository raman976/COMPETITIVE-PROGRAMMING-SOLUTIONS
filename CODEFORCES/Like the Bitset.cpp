...
// p of length n, so that for each 1≤i≤n, where si=1

// , the following holds:

//     For each interval [l,r]

// (1≤l≤r≤n) whose length is at least k (i.e. r−l+1≥k), if it covers position i (i.e. l≤i≤r), then the maximum element among pl,pl+1,…,pr is not pi
...
// integers p1,p2,…,pn (1≤pi≤n, all pi
...
// is i=3. There are three distinct intervals [l,r] covering index 3, whose length is at least k=3: [1,3], [1,4], and [2,4]
// ;
// And, for each of the three intervals, the maximum element among pl,…,pr
// should be p2=4, which is not equal to p3=3
