...
// , b=1: This means the array is [2] — it is impossible to add the signs '+' or '-' to get 0
// as a result;
// a=0
// , b=3: This means the array is [2,2,2] — it is impossible to add the signs '+' or '-' to get 0
// as a result;
// a=2
// , b=0: This means the array is [1,1] — it is possible to add the signs '+' or '-' to get 0 as a result (+1−1=0
// );
// a=2
// , b=3: This means the array is [1,1,2,2,2] — it is possible to add the signs '+' or '-' to get 0 as a result (+1+1−2−2+2=0
...
using namespace std;int main() {
    ...
    while (z--) {
        ...
        int useTwo = min(b, target / 2);
        target -= useTwo * 2;        if (target <= a) cout << "YES\n";
        else cout << "NO\n";
    }
    return 0;
}