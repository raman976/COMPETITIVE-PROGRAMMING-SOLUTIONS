...
# and k; k is an odd number not less than 3. Your task is to turn n into 0

# .

# To do this, you can perform the following operation any number of times: choose a number x
# from 1 to k and subtract it from n. However, if the current value of n is even (divisible by 2), then x must also be even, and if the current value of n is odd (not divisible by 2), then x
...
# from 39 to get 34. Then subtract 6 five times to get 4. Finally, subtract 4 to get 0
