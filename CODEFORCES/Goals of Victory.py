...
integers a1,a2,a3,…,an−1 (−100≤ai≤100) — the efficiency of n−1
...
teams that has the efficiency of 3 teams be 3, −4, and 5 will always have the efficiency of the 4-th team be −4.
'''
########################################################################
########################################################################
def f():
