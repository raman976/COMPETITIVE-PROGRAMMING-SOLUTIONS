...
// There are n
// apple trees arranged in a circle. Each tree bears exactly one apple, and the beauty of the apple on the i-th tree is given by bi for all 1≤i≤n. You start in front of tree 1
...
// , you move to tree i+1 for 1≤i≤n−1, and from tree n, you move back to tree 1
...
// and you eat the apple on tree 1 (beauty 2), you cannot eat the apples on trees 2 and 3 because their beauties are not greater than 2. However, you may eat the apple on tree 4 since b4=3>2
...
// ).
// At tree 1
// , skip the apple. You are not allowed to eat the apple as its beauty (b1=1) is not greater than the beauty of the last apple you ate (b5=2
// ).
// At tree 2
